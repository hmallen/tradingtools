...
class Display(threading.Thread):
    ...
    def create_widgets(self):
        ...
        analysis_main_subframes = {
            'buys': {
                'main': tk.LabelFrame(self.analysis_frame['master'], text='Buys')
            },
            'sells': {
                'main': tk.LabelFrame(self.analysis_frame['master'], text='Sells')
            },
            'all': {
                'main': tk.LabelFrame(self.analysis_frame['master'], text='All')
            }
        }
        ...
        analysis_period_subframes = {
            'buys': {
                'current': tk.LabelFrame(self.analysis_frame['buys']['main'], text='Current'),
                'last': tk.LabelFrame(self.analysis_frame['buys']['main'], text='Last'),
                'difference': tk.LabelFrame(self.analysis_frame['buys']['main'], text='Difference')
            },
            'sells': {
                'current': tk.LabelFrame(self.analysis_frame['sells']['main'], text='Current'),
                'last': tk.LabelFrame(self.analysis_frame['sells']['main'], text='Last'),
                'difference': tk.LabelFrame(self.analysis_frame['sells']['main'], text='Difference')
            },
            'all': {
                'current': tk.LabelFrame(self.analysis_frame['all']['main'], text='Current'),
                'last': tk.LabelFrame(self.analysis_frame['all']['main'], text='Last'),
                'difference': tk.LabelFrame(self.analysis_frame['all']['main'], text='Difference')
            }
        }
        ...
        ## Trade Frame ##
        # Trade Titles
        self.widgets['trade']['titles']['main'] = tk.Label(self.trade_frame['master'], text='Last Trade')
        ...
        # Trade Text Labels
        self.widgets['trade']['text']['price'] = tk.Label(self.trade_frame['master'], text='Price:')
        self.widgets['trade']['text']['quantity'] = tk.Label(self.trade_frame['master'], text='Quantity:')
        self.widgets['trade']['text']['amount'] = tk.Label(self.trade_frame['master'], text='Amount:')

        # Trade Variables
        self.widgets['trade']['variables']['price'] = tk.Label(self.trade_frame['master'], textvariable=self.variables['trade']['price'], compound=tk.RIGHT)
        self.widgets['trade']['variables']['quantity'] = tk.Label(self.trade_frame['master'], textvariable=self.variables['trade']['quantity'])
        self.widgets['trade']['variables']['amount'] = tk.Label(self.trade_frame['master'], textvariable=self.variables['trade']['amount'])

        ## Analysis Frame ##
        # Analysis Titles
        self.widgets['analysis']['titles']['main'] = tk.Label(self.analysis_frame['master'], text='Analysis Info')
        ...
        ## Menu Frame ##
        # Status
        self.widgets['menu']['variables']['status'] = tk.Label(self.menu_frame['master'], textvariable=self.variables['trade']['status'])

        # Buttons
        self.widgets['menu']['buttons']['quit'] = tk.Button(self.menu_frame['master'], text='Quit', command=self.stop_display)

        # Comboboxes
        self.widgets['menu']['comboboxes']['exchange'] = ttk.Combobox(self.menu_frame['exchange'], textvariable=self.variables['menu']['exchange'], values=self.available_exchanges)
        self.widgets['menu']['comboboxes']['market'] = ttk.Combobox(self.menu_frame['market'], textvariable=self.variables['menu']['market'], values=self.available_markets)
        self.widgets['menu']['comboboxes']['interval'] = ttk.Combobox(self.menu_frame['interval'], textvariable=self.variables['menu']['interval'], values=self.available_intervals)
        ...
        self.menu_frame['exchange'].grid(row=0, column=3)
        self.menu_frame['market'].grid(row=0, column=4)
        self.menu_frame['interval'].grid(row=0, column=5)
        ...
        self.widgets['menu']['comboboxes']['market'].grid(row=0, column=1)
        self.widgets['menu']['comboboxes']['interval'].grid(row=0, column=2)
